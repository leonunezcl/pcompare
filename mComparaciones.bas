...
Private Sub CompararApis(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Apis ..."
...
Private Sub CompararArreglos(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Arrays ..."
...
Private Sub CompararConstantes(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Constantes ..."
...
Private Sub CompararEnumeraciones(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Enumeraciones ..."
...
Private Sub CompararEventos(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Eventos ..."
...
Private Sub CompararProcedimientos(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    If TipoProc = TIPO_FUN Then
        ...
        frmMain.stbMain.Panels(5).Text = "Funciones ..."
    ElseIf TipoProc = TIPO_PROPIEDAD Then
        Call HelpCarga("Propiedades ...")
        frmMain.stbMain.Panels(5).Text = "Propiedades ..."
    Else
        Call HelpCarga("Procedimientos ...")
        frmMain.stbMain.Panels(5).Text = "Procedimientos ..."
    End If
    ...
    For r1 = 1 To UBound(ProyectoO.aArchivos(k).aRutinas)
        If ProyectoO.aArchivos(k).Explorar Then
            ...
            If ProyectoO.aArchivos(k).aRutinas(r1).Tipo = TipoProc Then
                        ...
                        If ProyectoD.aArchivos(j).aRutinas(r2).Tipo = TipoProc Then
                            ...
                            If LCase$(NombreO) = LCase$(NombreD) Then
                                ...
                                If NombreProcO <> NombreProcD Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Declaración Función", "", "<" & NombreProcO & ">", "<" & NombreProcD & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                    ...
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Declaración Procedimiento", "", "<" & NombreProcO & ">", "<" & NombreProcD & ">")
                                    End If
                                End If
                                ...
                                If r1tld <> r2tld Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Total lineas de codigo", "", "<" & r1tld & ">", "<" & r2tld & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen, "Propiedades", 0, "Total lineas de codigo", "", "<" & r1tld & ">", "<" & r2tld & ">")
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Total lineas de codigo", "", "<" & r1tld & ">", "<" & r2tld & ">")
                                    End If
                                End If
                                ...
                                If r1tlb <> r2tlb Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Total lineas en blanco", "", "<" & r1tlb & ">", "<" & r2tlb & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen, "Propiedades", 0, "Total lineas en blanco", "", "<" & r1tlb & ">", "<" & r2tlb & ">")
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Total lineas en blanco", "", "<" & r1tlb & ">", "<" & r2tlb & ">")
                                    End If
                                End If
                                ...
                                If r1tlc <> r2tlc Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Total lineas comentarios", "", "<" & r1tlc & ">", "<" & r2tlc & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen, "Propiedades", 0, "Total lineas comentarios", "", "<" & r1tlc & ">", "<" & r2tlc & ">")
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Total lineas comentarios", "", "<" & r1tlc & ">", "<" & r2tlc & ">")
                                    End If
                                End If
                                ...
                                If r1tva <> r2tva Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Total Variables Fun.", "", "<" & r1tva & ">", "<" & r2tva & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen, "Propiedades", 0, "Total Variables Prop.", "", "<" & r1tva & ">", "<" & r2tva & ">")
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Total Variables Sub.", "", "<" & r1tva & ">", "<" & r2tva & ">")
                                    End If
                                End If
                                ...
                                If rp1 <> rp2 Then
                                    If TipoProc = TIPO_FUN Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen & "<" & NombreO & ">", "Funciones", 0, "Total Parámetros", "", "<" & rp1 & ">", "<" & rp2 & ">")
                                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen & "<" & NombreO & ">", "Propiedades", 0, "Total Parámetros", "", "<" & rp1 & ">", "<" & rp2 & ">")
                                    Else
                                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen & "<" & NombreO & ">", "Procedimientos", 0, "Total Parámetros", "", "<" & rp1 & ">", "<" & rp2 & ">")
                                    End If
                                End If
                                ...
                                For rp1 = 1 To UBound(ProyectoO.aArchivos(k).aRutinas(r1).Aparams)
                                    ...
                                    If Not FoundP Then
                                        If TipoProc = TIPO_FUN Then
                                            Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen & "<" & NombreO & ">", "Funciones", 0, "Parametro Función No Existe en Destino", "", "<" & NombrePO & ">", "")
                                        ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        ...
                                        Else
                                            Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen & "<" & NombreO & ">", "Procedimientos", 0, "Parametro Procedimiento No Existe en Destino", "", "<" & NombrePO & ">", "")
                                        End If
                                    End If
                                Next rp1
                                ...
                                For rp2 = 1 To UBound(ProyectoD.aArchivos(j).aRutinas(r2).Aparams)
                                    ...
                                    If Not FoundP Then
                                        If TipoProc = TIPO_FUN Then
                                            Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen & "<" & NombreO & ">", "Funciones", 0, "Parametro Función No Existe en Origen", "", "", "<" & NombrePO & ">")
                                        ElseIf TipoProc = TIPO_PROPIEDAD Then
                                        ...
                                        Else
                                            Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen & "<" & NombreO & ">", "Procedimientos", 0, "Parametro Procedimiento No Existe en Origen", "", "", "<" & NombrePO & ">")
                                        End If
                                    End If
                                Next rp2
                                    ...
                                    If glbOpcionComparar Then   'comparar linea x linea
                                        For rp2 = 1 To UBound(ProyectoD.aArchivos(j).aRutinas(r2).aCodigoRutina)
                                            ...
                                            If LCase$(LineaO) <> LCase$(LineaD) Then
                                                If TipoProc = TIPO_FUN Then
                                                    Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen & "<" & NombreO & ">", "Funciones", 0, "Código Función", "", "<" & LineaO & ">", "<" & LineaD & ">")
                                                ElseIf TipoProc = TIPO_PROPIEDAD Then
                                                    Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen & "<" & NombreO & ">", "Propiedades", 0, "Código Propiedad", "", "<" & LineaO & ">", "<" & LineaD & ">")
                                                Else
                                                    Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen & "<" & NombreO & ">", "Procedimientos", 0, "Código Procedimiento", "", "<" & LineaO & ">", "<" & LineaD & ">")
                                                End If
                                            End If
                                        Next rp2
                                    Else
                                        ...
                                        If Not FoundCode Then
                                            If TipoProc = TIPO_FUN Then
                                                Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen & "<" & NombreO & ">", "Funciones", 0, "Código Función", "", "<" & LineaO & ">", "")
                                            ElseIf TipoProc = TIPO_PROPIEDAD Then
                                                Call AgregaListaDeDiferencias(C_ICONO_PROPIEDAD_PUBLICA, UbiOrigen & "<" & NombreO & ">", "Propiedades", 0, "Código Propiedad", "", "<" & LineaO & ">", "")
                                            Else
                                                Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen & "<" & NombreO & ">", "Procedimientos", 0, "Código Procedimiento", "", "<" & LineaO & ">", "")
                                            End If
                                        End If
                                    End If
                                Next rp1
                ...
                If Not Found Then
                    If TipoProc = TIPO_FUN Then
                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Función No Existe en Destino", "", "<" & NombreO & ">", NombreProcO)
                    ElseIf TipoProc = TIPO_PROPIEDAD Then
                    ...
                    Else
                        Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Procedimiento No Existe en Destino", "", "<" & NombreO & ">", NombreProcO)
                    End If
                End If
            End If
        End If
    ...
    For r1 = 1 To UBound(ProyectoD.aArchivos(j).aRutinas)
        If ProyectoD.aArchivos(j).Explorar Then
            ...
            TipoProc2 = ProyectoD.aArchivos(j).aRutinas(r1).Tipo
            ...
            If Not Found Then
                If TipoProc2 = TIPO_FUN Then
                    Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_FUNCION, UbiOrigen, "Funciones", 0, "Función No Existe en Origen", "", "", "<" & NombreProcO & ">")
                ElseIf TipoProc2 = TIPO_PROPIEDAD Then
                ...
                Else
                    Call AgregaListaDeDiferencias(C_ICONO_PUBLIC_SUB, UbiOrigen, "Procedimientos", 0, "Procedimiento No Existe en Origen", "", "", "<" & NombreProcO & ">")
                End If
            End If
        End If
    Next r1
...
Private Sub CompararSeccionGeneral(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Sección generales ..."
...
Private Sub CompararTipos(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Tipos ..."
...
Private Sub CompararVariables(ByVal k As Integer, ByVal UbiOrigen As String, _
    ...
    frmMain.stbMain.Panels(5).Text = "Variables ..."
...
Private Sub DiferenciaInformacionArchivos()
    ...
    For k = 1 To UBound(ProyectoD.aArchivos)
        If ProyectoD.aArchivos(k).Explorar Then
            ...
            'verificar el tipo de archivo
            If ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_FRM Then
                Icono = C_ICONO_FORM
            ElseIf ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_BAS Then
                Icono = C_ICONO_BAS
            ElseIf ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_CLS Then
                Icono = C_ICONO_CLS
            ElseIf ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_OCX Then
                Icono = C_ICONO_CONTROL
            ElseIf ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_PAG Then
                Icono = C_ICONO_PAGINA
            ElseIf ProyectoD.aArchivos(k).TipoDeArchivo = TIPO_ARCHIVO_DSR Then
                Icono = C_ICONO_DESIGNER
            End If
            ...
            For j = 1 To UBound(ProyectoO.aArchivos)
                If ProyectoO.aArchivos(j).Explorar Then
...
Private Sub DiferenciaInformacionArchivosProyecto(ByVal TipoArchivo As eTipoArchivo, ByVal Icono As Integer)
    ...
    If TipoArchivo = TIPO_ARCHIVO_FRM Then
        Call HelpCarga("Procesando formularios ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_BAS Then
        Call HelpCarga("Procesando módulos .bas ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_CLS Then
        Call HelpCarga("Procesando módulos .cls ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_DSR Then
        Call HelpCarga("Procesando diseñadores ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_OCX Then
        Call HelpCarga("Procesando controles de usuario ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_PAG Then
        Call HelpCarga("Procesando páginas de propiedades ...")
    ElseIf TipoArchivo = TIPO_ARCHIVO_REL Then
        Call HelpCarga("Procesando archivos relacionados ...")
    End If
    
    Call ShowProgress(True)
    frmMain.pgbStatus.Max = UBound(ProyectoO.aArchivos)
    
    'ciclar x el proyecto origen
    For k = 1 To UBound(ProyectoO.aArchivos)
        frmMain.pgbStatus.Value = k
        frmMain.stbMain.Panels(2).Text = k & " de " & UBound(ProyectoO.aArchivos)
        frmMain.stbMain.Panels(4).Text = Round(k * 100 / UBound(ProyectoO.aArchivos), 0) & " %"
        DoEvents
        If ProyectoO.aArchivos(k).Explorar Then
